...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Newsletter.mailing_list'
        db.delete_column('newsletter_newsletter', 'mailing_list_id')


    def backwards(self, orm):
        
        # Adding field 'Newsletter.mailing_list'
        db.add_column('newsletter_newsletter', 'mailing_list', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='mailing_list', to=orm['newsletter.MailingList']), keep_default=False)
