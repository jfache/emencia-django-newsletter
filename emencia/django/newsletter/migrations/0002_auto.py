...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field mailing_lists on 'Newsletter'
        db.create_table('newsletter_newsletter_mailing_lists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('newsletter', models.ForeignKey(orm['newsletter.newsletter'], null=False)),
            ('mailinglist', models.ForeignKey(orm['newsletter.mailinglist'], null=False))
        ))
        db.create_unique('newsletter_newsletter_mailing_lists', ['newsletter_id', 'mailinglist_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field mailing_lists on 'Newsletter'
        db.delete_table('newsletter_newsletter_mailing_lists')
    ...
    models = {
        ...
        'newsletter.newsletter': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mailing_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mailing_list'", 'to': "orm['newsletter.MailingList']"}),
            'mailing_lists': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'mailing_lists'", 'symmetrical': 'False', 'to': "orm['newsletter.MailingList']"}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
